...
public class CadastroEntregasSteps {
    ...
    public void queEuTenhaOsSeguintesDadosDaEntrega(List<Map<String, String>> rows) {
        ...
        {
            cadastroEntregasService.setFieldsDelivery(colums.get("campo"), colums.get("valor"));
        }
    }
    ...
    public void queEuRecupereOIDDaEntregaCriadaNoContexto() {
        cadastroEntregasService.retrievedIdDelivery();
    }
    ...
    public void aRespostaDaRequisiçãoDeveEstarEmConformidadeComOContratoSelecionado() throws IOException{
        Set<ValidationMessage> validationMessages = cadastroEntregasService.validateResponseAgainstSchema();
        Assert.assertTrue("O contrato está invalido. Erros encontrados: " + validationMessages, validationMessages.isEmpty());
    }
}
